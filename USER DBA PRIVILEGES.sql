...
BEGIN 
    ...
    ELSE
        IF(CHECK_VALID_STRING(MANV)) THEN
...
/
GRANT SELECT ON PHONGBAN TO U_DBA WITH GRANT OPTION;
/
CREATE OR REPLACE VIEW U_DBA.PHONGBAN AS
SELECT * FROM SYS.PHONGBAN;

/
GRANT SELECT ON NHANVIEN TO U_DBA WITH GRANT OPTION;
/
CREATE OR REPLACE VIEW U_DBA.NHANVIEN AS
SELECT * FROM SYS.NHANVIEN;
/
GRANT SELECT ON DEAN TO U_DBA WITH GRANT OPTION;
/
CREATE OR REPLACE VIEW U_DBA.DEAN AS
SELECT * FROM SYS.DEAN;
/
GRANT SELECT ON PHANCONG TO U_DBA WITH GRANT OPTION;
/
CREATE OR REPLACE VIEW U_DBA.PHANCONG AS
SELECT * FROM SYS.PHANCONG;
/
